...
**Current implementation status**: Phases 1 through 3 are complete. Phase 4's schema and corrections through revision 036 are implemented and CI-verified; a final review reopened one character-language integrity defect and three focused verification gaps. Clear [the Phase 4 issue register](../docs/PHASE4_REMAINING_ISSUES.md) before beginning [Phase 5](../docs/PLAN.md#phase-5-locations-and-dungeon-play). No API or UI exists yet.
