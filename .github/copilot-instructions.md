...
**Current implementation status**: Phases 1 through 4 are complete ([../docs/PHASE4_REMAINING_ISSUES.md](../docs/PHASE4_REMAINING_ISSUES.md) is now a closed historical record). Phase 5's location/dungeon schema and two pre-merge corrections passes are implemented and merged, but its post-merge closeout is still open; finish [../docs/PHASE5_REMAINING_ISSUES.md](../docs/PHASE5_REMAINING_ISSUES.md) before starting [Phase 6](../docs/PLAN.md#phase-6-events-and-interactions). No API or UI exists yet.
