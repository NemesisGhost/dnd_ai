...
This is an architecture restart. Phases 1 through 5 are complete, including Phase 4's initial ruleset/shared-character schema, its first corrections pass, and all three closeout passes (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md); [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is now a closed historical record) and Phase 5's location/dungeon schema, which also pulled a minimal slice of the knowledge domain forward from Phase 7 (see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md)). The current target is [Phase 6: events and interactions](docs/PLAN.md#phase-6-events-and-interactions). See [README.md § Current Status](README.md#current-status).
