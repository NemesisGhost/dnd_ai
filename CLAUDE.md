...
This is an architecture restart. Phases 1 through 4 are complete, including Phase 4's initial ruleset/shared-character schema, its first corrections pass, and all three closeout passes (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md); [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is a closed historical record). Phase 5 (location/dungeon schema, a minimal knowledge-domain slice pulled forward from Phase 7, production invariants, resumed-waiter tests, and independent final-state assertions) is also complete, including its formal-verification closeout (see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md); [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md) is a closed historical record). Both the Phase 6 repository-context-modularization gate and the Phase 5 formal-correctness gate are closed. The current target is [Phase 6: events and interactions](docs/PLAN.md#phase-6-events-and-interactions). See [README.md § Current Status](README.md#current-status).
