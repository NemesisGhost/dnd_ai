...
This is an architecture restart. Phases 1 through 5 are complete, including Phase 4's initial ruleset/shared-character schema, its first corrections pass, and all three closeout passes (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md); [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is a closed historical record), and Phase 5's location/dungeon schema, minimal knowledge-domain slice pulled forward from Phase 7, and five corrections passes — two pre-merge, three post-merge (see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md); [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md) is now a closed historical record). Both Phase 6 entry gates (repository context modularization and Phase 5 correctness) are closed, pending confirmation from the CI run for the pass that closed the second one — see [docs/PHASE5_VERIFICATION.md § Fifth exit review corrections](docs/PHASE5_VERIFICATION.md#fifth-exit-review-corrections-2026-08-03). See [README.md § Current Status](README.md#current-status).
