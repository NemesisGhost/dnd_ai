...
This is an architecture restart. Phases 1 through 3 are complete. Phase 4's initial ruleset/shared-character schema and corrections through revision 034 are implemented and CI-verified, but the post-closeout review reopened [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md). Clear that register before beginning [Phase 5: locations and dungeon play](docs/PLAN.md#phase-5-locations-and-dungeon-play). See [README.md § Current Status](README.md#current-status) and [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md).
