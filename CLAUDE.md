...
This is an architecture restart. Phases 1 through 3 are complete. Phase 4's initial ruleset/shared-character schema and corrections through revision 036 are implemented and CI-verified, but a final review reopened one character-language integrity defect and three focused verification gaps (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md) and the active [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) gate). Clear that gate before beginning [Phase 5: locations and dungeon play](docs/PLAN.md#phase-5-locations-and-dungeon-play). See [README.md § Current Status](README.md#current-status).
