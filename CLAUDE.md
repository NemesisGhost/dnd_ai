...
This is an architecture restart. Phases 1 through 5 are complete, including Phase 4's initial ruleset/shared-character schema, its first corrections pass, and all three closeout passes (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md); [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is a closed historical record), and Phase 5's location/dungeon schema, minimal knowledge-domain slice pulled forward from Phase 7, and four corrections passes — two pre-merge, two post-merge (see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md); [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md) is now a closed historical record). Do not begin [Phase 6: events and interactions](docs/PLAN.md#phase-6-events-and-interactions) feature/schema work until the Phase 6 context-modularization entry gate closes. See [README.md § Current Status](README.md#current-status).
