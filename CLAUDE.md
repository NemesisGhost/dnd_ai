...
This is an architecture restart. Phases 1 through 4 are complete, including Phase 4's initial ruleset/shared-character schema, its first corrections pass, and all three closeout passes (see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md); [docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is now a closed historical record). Phase 5's location/dungeon schema is implemented and merged, including the minimal knowledge-domain slice pulled forward from Phase 7, but its post-merge closeout remains open; see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md) and [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md). Finish that register before starting [Phase 6: events and interactions](docs/PLAN.md#phase-6-events-and-interactions). See [README.md § Current Status](README.md#current-status).
