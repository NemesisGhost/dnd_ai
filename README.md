...
The architecture is established and the database foundation is being implemented. Phases 1 (database bootstrap), 2 (core world platform), 3 (timelines and campaigns), and 4 (rules and shared characters, including its corrections pass and all three closeout passes — see [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md)) are complete. Phase 5 (locations and dungeon play) and three corrections passes are implemented, merged, and CI-verified, but Phase 5 does not yet meet its full correctness requirements: one dungeon-area concurrency race remains, and the affected concurrency tests do not prove that their original waiting statements resume and revalidate. [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md) is the open completion gate and [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md) preserves the valid evidence and its limits. Phase 6 feature/schema work is queued until both that gate and the repository-context modularization gate in [docs/PLAN.md](docs/PLAN.md#phase-6-events-and-interactions) close.
...
Phases 1 through 4 are **complete**; see [docs/PHASE1_VERIFICATION.md](docs/PHASE1_VERIFICATION.md), [docs/PHASE2_VERIFICATION.md](docs/PHASE2_VERIFICATION.md), [docs/PHASE3_VERIFICATION.md](docs/PHASE3_VERIFICATION.md), and [docs/PHASE4_VERIFICATION.md](docs/PHASE4_VERIFICATION.md) for the evidence ([docs/PHASE4_REMAINING_ISSUES.md](docs/PHASE4_REMAINING_ISSUES.md) is a closed historical record). Phase 5 is merged but remains the current correctness closeout because one schema-integrity race and its resumed-waiter verification are still open; see [docs/PHASE5_VERIFICATION.md](docs/PHASE5_VERIFICATION.md) and [docs/PHASE5_REMAINING_ISSUES.md](docs/PHASE5_REMAINING_ISSUES.md). [Phase 6](docs/PLAN.md#phase-6-events-and-interactions) feature/schema work is queued behind that closeout and its separate context-modularization entry gate; [§23.1](docs/PLAN.md#231-phase-exit-review) defines the phase-close process.
